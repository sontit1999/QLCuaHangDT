...
namespace _206_215_qtm18c
{
    public partial class frmDMNhaCC : Form
    {
        ...
        private void frmDMNhaCC_Load(object sender, EventArgs e)
        {
            ...
            // load dữ liệu mặc định lên data gridview
            LoadDataGridView();
        }

        private void LoadDataGridView()
        {  
            // truy vấn lấy dữ liệu từ bảng nhà cung cấp hiển thị lên datagridview
            string sql;
            ...
            DataGridView.Columns[0].HeaderText = "Mã  hãng";
            DataGridView.Columns[1].HeaderText = "Tên hãng";
        ...
        {  
            // kiểm tra xem nút thêm có đang được vô hiệu hóa hay ko ?
        ...
        {   
            // kích hoạt và vô hiệu hóa các button
        ...
        {
            string sql;
            if (tblNCC.Rows.Count == 0) // ktra nếu hàng = 0 thì thực hiện
            {
                MessageBox.Show("Không còn dữ liệu", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            ...
            // hiển thị hộp thoại xác nhận xem có xóa hay ko ?
        ...
        {   
            // reset value các textbox và vô hiệu hóa, kích hoạt các button
            ResetValue();
            btnBoqua.Enabled = false;
            btnThem.Enabled = true;
            btnXoa.Enabled = true;
        ...
        {   
            // kiểm tra nhập vào phím enter hay ko ?
